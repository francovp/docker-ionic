...
ENV ANDROID_PLATFORMS_VERSION ${ANDROID_PLATFORMS_VERSION:-27}
...
ARG NPM_VERSION
ENV NPM_VERSION ${NPM_VERSION:-6.4.1}
...
ARG IONIC_VERSION
ENV IONIC_VERSION ${IONIC_VERSION:-4.1.2}

ARG TYPESCRIPT_VERSION
ENV TYPESCRIPT_VERSION ${TYPESCRIPT_VERSION:-2.9.2}
